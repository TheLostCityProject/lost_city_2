...
class Blit:
        """加载图像的类"""
        def __init__(self,lc_game):
            super().__init__()
            self.screen = lc_game.screen
            self.settings = lc_game.settings
            with open('main/surface_3.json',"r",encoding='utf8') as f:
...
#初始化图像
        def _image_events(self):
            ...
            #button_hide_dark"D:\lost_city\images\button_hide_dark.png"
